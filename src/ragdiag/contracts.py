...
def check_log(payload: dict) -> ContractReport:
    ...
    분류를 돌리기 전에 부른다. 여기서 나온 줄들이 실행 환경에서 이쪽으로 돌아오는
    포맷 정보의 전부다.
    """
    users: list[dict] = []
